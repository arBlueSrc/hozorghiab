...
<body id="main-container" class="default semi-dark">
                ...
                <div class="col-12  align-self-center">
                    <div class="sub-header mt-3 py-3 px-3 align-self-center d-sm-flex w-100 rounded">
                        ...
                        <ol class="breadcrumb bg-transparent align-self-center m-0 p-0">
                            ...
                            <li class="breadcrumb-item active"><a href="#">ثبت کاربر جدید</a></li>
                        </ol>
                    </div>
                </div>
            </div>
                                    ...
                                    <div class="col-12">
                                        <form action="control/hozor/insert.php" method="post" enctype="multipart/form-data">
                                            ...
                                            <div class="form-group row">
                                                <label for="name" class="col-sm-2 col-form-label">اسم و فامیلی</label>
                                                <div class="col-sm-10">
                                                    <input type="text" class="form-control" id="name" name="name" placeholder="اسم و فامیلی">
                                                </div>
                                            </div>
    ...
    <!-- START: Footer-->
    <footer class="site-footer">© 2022 ثبت کاربر جدید.</footer>
    <!-- END: Footer-->
