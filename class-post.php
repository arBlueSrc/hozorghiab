                                    ...
                                    <div class="col-12">
                                        <form action="control/hozor/insert.php" method="post" enctype="multipart/form-data">
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <label for="start" class="col-sm-2 col-form-label">ساعت شروع</label>
                                                <div class="col-sm-10">
                                                    <input type="time" id="start" name="start" min="09:00" max="18:00" required>
                                                </div>

                                            </div>

                                            <div class="form-group row">
                                                <label for="end" class="col-sm-2 col-form-label">ساعت پایان</label>
                                                <div class="col-sm-10">
                                                    <input type="time" id="end" name="end" min="09:00" max="18:00" required>
                                                </div>
                                            </div>
