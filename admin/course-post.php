                ...
                <div class="col-12  align-self-center">
                    <div class="sub-header mt-3 py-3 px-3 align-self-center d-sm-flex w-100 rounded">
                        <div class="w-sm-100 ml-auto">
                            <h4 class="mb-0">ثبت دوره جدید</h4>
                        </div>

                        <ol class="breadcrumb bg-transparent align-self-center m-0 p-0">
                            <li class="breadcrumb-item">خانه</li>
                            <li class="breadcrumb-item">دوره ها</li>
                            <li class="breadcrumb-item active"><a href="#">ثبت دوره جدید</a></li>
                        </ol>
                    </div>
                </div>
            </div>
                                    ...
                                    <div class="col-12">
                                        <form action="control/hozor/insert.php" method="post" enctype="multipart/form-data">
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-10">
                                                    <input type="text" class="form-control" id="name" name="name" placeholder="نام دوره">
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group row">
                                                <div class="col-sm-10">
                                                    <button type="submit" name="save-course" class="btn btn-primary">ذخیره اطلاعات</button>
                                                </div>
                                            </div>
