    ...
    <main>
        <div class="container-fluid">
                ...
                <div class="col-12  align-self-center">
                    <div class="sub-header mt-3 py-3 px-3 align-self-center d-sm-flex w-100 rounded">
                        <div class="w-sm-100 ml-auto">
                            <h4 class="mb-0">لیست کلاس ها</h4>
                        </div>

                        <ol class="breadcrumb bg-transparent align-self-center m-0 p-0">
                            <li class="breadcrumb-item">لیست کلاس ها</li>
                            <li class="breadcrumb-item">کلاس ها</li>
            ...
            <div class="row ">
                <div class="col-12  align-self-center">
                    <div class="sub-header mt-3 py-3 px-3 align-self-center d-sm-flex w-100 rounded">
                        <form method="post" action="class-post.php" enctype="multipart/form-data">
                            <input type="hidden" id="course-id" name="course-id" value="<?php echo $_POST['course-id']; ?>" />
                            <input type="submit" name="submit_file" value="اضافه کردن کلاس" class="btn btn-outline-primary" />
                        </form>
                    </div>
                </div>
            </div>
                        ...
                        <div class="card-body">
                            <div class="table-responsive">
                                <table id="example" class="display table dataTable table-striped table-bordered">
                                    ...
                                    <tbody>
                                        <?php foreach ($fetch->classes("DESC", "0", "500000", "", $_POST['course-id']) as $row) { ?>
                                            <tr>
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-6">
                                                            ...
                                                            <form method="post" action="report.php" enctype="multipart/form-data">
                                                                <input type="hidden" id="class-id" name="class-id" value="<?php echo $row['id']; ?>" />
                                                                <input type="submit" name="submit_file" value="گزارش حضور غیاب" class="btn btn-info" />
                                                            </form>
                                                        </div>
                                                        ...
                                                        <div class="col-6">
                                                            <a href="control/hozor/delete.php?del-class=<?php echo $row['id']; ?>&course-id=<?php echo $_POST['course-id']; ?>" style="color: #DC0003" onclick="return confirm('آیا از حذف این کلاس مطمئن هستید ؟');">
                                                                <span class="iconify" data-icon="mdi:trash-can-outline" data-width="25" data-height="25"></span></a>
                                                        </div>
