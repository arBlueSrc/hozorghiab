                ...
                <div class="col-12  align-self-center">
                    <div class="sub-header mt-3 py-3 px-3 align-self-center d-sm-flex w-100 rounded">
                        <div class="w-sm-100 ml-auto">
                            <h4 class="mb-0">مجری های من</h4>
                        </div>

                        <ol class="breadcrumb bg-transparent align-self-center m-0 p-0">
                            <li class="breadcrumb-item">لیست مجری ها</li>
                ...
                <div class="col-12  align-self-center">
                    <div class="sub-header mt-3 py-3 px-3 align-self-center d-sm-flex w-100 rounded">
                        <form method="post" action="admin-post.php" enctype="multipart/form-data">
                            <input type="submit" name="submit_file" value="اضافه کردن مجری" class="btn btn-outline-primary" />
                        </form>
                    </div>
                </div>
            </div>
                        ...
                        <div class="card-body">
                            <div class="table-responsive">
                                <table id="example" class="display table dataTable table-striped table-bordered">
                                    ...
                                    <tbody>
                                        <?php foreach ($fetch->adminList("DESC", "0", "500000", "") as $row) { ?>
                                            <tr>
                                                ...
                                                <td width="30%">
                                                    ...
                                                    <div class="row justify-content-around">
                                                        ...
                                                        <div class="col-6">
                                                            <form method="post" action="assign-admin.php" enctype="multipart/form-data">
                                                                <input type="hidden" id="admin-id" name="admin-id" value="<?php echo $row['id']; ?>" />
                                                                <input type="submit" name="submit_file" value="دوره های این مجری" class="btn btn-dark" />
                                                            </form>
                                                        </div>

                                                        <div class="col-6">
                                                            <a href="control/hozor/delete.php?del-admin=<?php echo $row['id']; ?>" style="color: #DC0003" onclick="return confirm('آیا از حذف این مجری مطمئن هستید ؟');"> <span class="iconify" data-icon="mdi:trash-can-outline" data-width="25" data-height="25"></span></a>
