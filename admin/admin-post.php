                ...
                <div class="col-12  align-self-center">
                    <div class="sub-header mt-3 py-3 px-3 align-self-center d-sm-flex w-100 rounded">
                        <div class="w-sm-100 ml-auto">
                            <h4 class="mb-0">ثبت مجری جدید</h4>
                        </div>

                        <ol class="breadcrumb bg-transparent align-self-center m-0 p-0">
                            <li class="breadcrumb-item">خانه</li>
                            <li class="breadcrumb-item">مجری ها</li>
                            <li class="breadcrumb-item active"><a href="#">ثبت مجری جدید</a></li>
                        </ol>
                    </div>
                </div>
            </div>
                ...
                <div class="col-12 col-lg-9 mt-3">
                    <div class="card">
                        <div class="card-header">
                            <h4 class="card-title">ثبت مجری جدید</h4>
                        </div>
                                    ...
                                    <div class="col-12">
                                        <form action="control/hozor/insert.php" method="post" enctype="multipart/form-data">
                                            ...
                                            <div class="form-group row">
                                                <label for="name" class="col-sm-2 col-form-label">نام مجری</label>
                                                <div class="col-sm-10">
                                                    <input type="text" class="form-control" id="name" name="name" placeholder="نام مجری">
                                                </div>
                                            </div>

                                            <div class="form-group row">
                                                <label for="username" class="col-sm-2 col-form-label">نام کاربری مجری</label>
                                                <div class="col-sm-10">
                                                    <input type="text" class="form-control" id="username" name="username" placeholder="نام کاربری مجری">
                                                </div>
                                            </div>

                                            <div class="form-group row">
                                                <label for="password" class="col-sm-2 col-form-label">رمز عبور مجری</label>
                                                <div class="col-sm-10">
                                                    <input type="text" class="form-control" id="password" name="password" placeholder="رمز عبور مجری">
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group row">
                                                <div class="col-sm-10">
                                                    <button type="submit" name="save-admin" class="btn btn-primary">ذخیره اطلاعات</button>
                                                </div>
                                            </div>
